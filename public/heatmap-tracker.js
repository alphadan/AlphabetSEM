...
(function() {
  ...
  appScript.onload = () => {
    ...
    dbScript.src = "https://www.gstatic.com/firebasejs/10.12.2/firebase-firestore-compat.js";
    document.head.appendChild(dbScript);

    dbScript.onload = () => {
      // 3. Initialize Firebase cleanly using your project credentials
      const firebaseConfig = {
        apiKey: "AIzaSyCx5Dl5DzVH6JftXxPzrSVWpMWVRAhfwRI", 
      ...
      document.addEventListener('click', function(e) {
        ...
        const pctY = ((e.pageY / document.documentElement.scrollHeight) * 100).toFixed(2);
